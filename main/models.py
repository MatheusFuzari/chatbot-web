...
class Trip(models.Model):
    ...
    categoryFK = models.ForeignKey(
        Category, related_name='categoryTrip', on_delete=models.CASCADE)
...
class Image(models.Model):
    ...
    tripFk = models.ForeignKey(
        Trip, related_name='tripImage', on_delete=models.CASCADE)
...
class Booking(models.Model):
    customUserFK = models.ForeignKey(
        CustomUser, related_name='customUserBooking', on_delete=models.CASCADE)
    tripFK = models.ForeignKey(
        Trip, related_name='trip', on_delete=models.CASCADE)
    startDate = models.DateField()
    endDate = models.DateField()
    purchaseValue = models.DecimalField(
...
class Payment(models.Model):
    ...
    bookingFK = models.ForeignKey(
        Booking, related_name='bookingPayment', on_delete=models.CASCADE)
...
class Availability(models.Model):
    tripFK = models.ForeignKey(
        Trip, related_name="tripAvailability", on_delete=models.CASCADE)
    bookingFK = models.ForeignKey(
        Booking, related_name="bookingAvailability", on_delete=models.CASCADE, null=True, blank=True)
...
class Conversation(models.Model):
    ...
    history = models.ForeignKey(
        ConversationHistory, related_name="history", on_delete=models.CASCADE)
